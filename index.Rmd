...
description: "Kitsa matemaatika teine kursus."
lang: en
include-before:
    - \input{title-page.tex}
title: "`r if (knitr::is_latex_output()) { '' } else { 'Kitsa matemaatika<br/>teine<br/>kursus' }`"
...
Märkasin, et õpilane kirjutas tuimalt ChatGPT'st lahendusi ümber ülesannetele, mille talle õppimiseks ja kinnistamiseks andsin. Ütlesin talle, miks ma need ülesanded talle andsin ja et testis ei ole võimalik ChatGPT'd kasutada. Kõndisin edasi. Kui tagasi vaatasin, oli õpilane lahkunud ja pinginaabri ka kaasa võtnud.
